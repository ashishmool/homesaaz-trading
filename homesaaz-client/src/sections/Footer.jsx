      ...
      <div className="max-container">
        <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
          <div className="flex flex-col items-start">
            <a href="/">
              <img src={footerLogo} alt="footer-logo" width={200} height={80} />
            </a>
            <p className="mt-6 text-base leading-7 font-montserrat text-white-400 sm:max-w-sm">
              Home Saaz offers top-class products tailored for the hospitality industry in Nepal. Discover premium quality and unparalleled service that caters to hotels, resorts, and more. Experience luxury and comfort with every product, designed to elevate your guest's experience.
              <span className="underline cursor-pointer hoverUnderline hover:no-underline">Learn more</span>
            </p>
