...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // Here you can implement the functionality for sending the query (email)
    ...
    return (
        <section id="contact-us" className="xl:padding-l wide:padding-r padding-b">
            <h2 className="text-4xl font-palanquin font-bold text-center">
                Contact
                <span className="text-coral-red"> Us</span>
            </h2>
            <div className="w-full flex xl:flex-row flex-col justify-center items-center min-h-screen max-container gap-10">
                ...
                <div className="xl:w-1/2 w-full flex flex-col justify-center items-center">
                    ...
                    {/*<div className="mt-10">*/}
                    {/*    <p className="font-montserrat text-lg text-slate-gray dark:text-gray-400">*/}
                    {/*        Email: <a href="mailto:homesaaznepal@gmail.com" className="text-coral-red">homesaaznepal@gmail.com</a>*/}
                    {/*    </p>*/}
                    {/*    <p className="font-montserrat text-lg text-slate-gray dark:text-gray-400">*/}
                    {/*        Phone: +977-1-4520661, 4520647*/}
                    {/*    </p>*/}
                    {/*</div>*/}
                </div>
            </div>
